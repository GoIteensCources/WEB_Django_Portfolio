...
def order_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messge_client = render_to_string('orders/email/confirmation.html', {'order': order})
            send_mail(
            ...
            message_admin = render_to_string('orders/email/admin_notification.html', {'order': order})
            send_mail(
